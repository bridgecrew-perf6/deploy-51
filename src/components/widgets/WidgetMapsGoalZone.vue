...
export default {
  ...
  data: () => ({
    resultButtons: [
      'Все',
      '<span class="circle red-circle">Голы</span>',
      '<span class="circle black-circle">Броски</span>',
    ],
    widgetBig: true,
    resultList: null,
  }),
...
.maps-goal__right {
  @include width-flex(40%) padding-left: 24px;
}
...
.maps-goal__indication-item {
  @include width-flex(33.3%) border-left: 2px solid rgba(0, 0, 0, 0.1);
