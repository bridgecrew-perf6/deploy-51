  ...
  <section class="sidebar-sp-profile">
    <div class="sidebar-sp-profile__header">
      <div class="sidebar-sp-profile__avatar-wrapper">
        <v-img v-if="sportsman.avatar" class="sidebar-sp-profile__avatar" :src="sportsman.avatar"></v-img>
        <v-img
          v-else
        ...
        ></v-img>
        <span class="sidebar-sp-profile__sp-number">{{ sportsman.team_number }}</span>
      </div>

      <div class="sidebar-sp-profile__about">
        <p class="sidebar-sp-profile__fullname">{{ sportsman.full_name }}, {{ sportsman.age }} лет</p>
        <span class="sidebar-sp-profile__position">Нападающий, Разряд II</span>
      </div>
    </div>
