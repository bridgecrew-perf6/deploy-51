<template lang="pug">
  .widget
    .widget-empty-image.d-none.d-sm-none.d-md-flex(v-if="false")
    .widget-header
      .widget-header__top
        img.drag-icon.mr-3(
      ...
      return [
        ...
        },
        {
          ...
          fillColor: {
            ...
            stops: [
              [0, 'rgba(95, 255, 39, 1)'],
              [0.25, 'rgba(95, 255, 39, 0.4342)'],
              [0.5, 'rgba(95, 255, 39, 0)'],
            ],
          },
          marker: {
          ...
          labels: {
            formatter: function () {
              ...
              if (diff > 0) {
                return (
                  this.value +
                  '<span class="xAxis_up" style="color:#3DC50D;position:relative;padding-left: 20px">' +
