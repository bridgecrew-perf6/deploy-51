        ...
        .item-estimate
          ...
          .block-white.block-flex.mb-6.pl-3
            ...
            .block-flex__right.d-flex.align-center.ml-auto
              .estimate-num.mr-6.text-red {{ item.mark }}
              base-button(
          ...
          .accordion-group
            v-expansion-panel.accordion-panel
              v-expansion-panel-header.accordion-panel__header
                ...
                .accordion-panel__header-desc.accordion-panel__header-desc_lesson
                  ...
                  .accordion-panel__header-desc_right.pr-10(v-if="canRating")
...
.accordion-panel__header-desc {
  @include width-flex(85%) display: flex;
...
.accordion-panel__header-desc_lesson {
