  ...
  <div>
    <v-dialog v-model="show" content-class="modal-homework" max-width="668">
      <div class="v-application v-application--is-ltr">
        ...
        <v-row class="mb-5">
          ...
          <v-col cols="5">
            <small-select
                ...
                :items="[
                         { id: '1', title: 'Физическое упражнение' },
                         { id: '2', title: 'Видео задание' },
                         { id: '3', title: 'Текстовое задание' },
                         { id: '4', title: 'Интерактивное задание' },
                         { id: '5', title: 'Творческое задание' },
                         ]"
            ...
            <v-col cols="6">
              <div class="d-flex justify-space-between h-100">
                <button class="d-flex align-center h-100 text-middle pointer">
                  <svg class="mr-2" width="16" height="15" viewBox="0 0 16 15"
            ...
            <v-col cols="12">
              <div class="library">
                <div class="library__select" v-if="!libraryList && !exerciseSearch.length" @click="libraryList = true">
                  <svg class="ico" width="108" height="96" viewBox="0 0 108 96" fill="none"
                       xmlns="http://www.w3.org/2000/svg">
                    <path
                      ...
                      <div class="library__footer">
                        <div class="library__data data">
                          <div class="data__list">
                            ...
                            <div class="data__item">
                              <svg class="data__ico" width="16" height="16"
                        ...
                        <div class="library__favorite favorite">
                          <svg class="favorite__ico" width="17" height="16"
        ...
        <div v-if="typeExercise == 2">
          ...
          <v-row class="mb-5">
            <div class="modal-comment">
              ...
              <button class="modal-comment-btn d-flex align-center h-100 text-middle pointer justify-end w-100"
                      @click="videoUrl = ''"
        ...
        <v-row>
          <v-col cols="12">
            <div class="d-flex justify-center pt-4 pb-4" @click="addPhysical" v-if="!edit">
              <base-button label="+ Добавить задание" type="submit"></base-button>
            </div>
            <div class="d-flex justify-center pt-4 pb-4" @click="editHomeWorkPhysical" v-if="edit">
    ...
    return {
      ...
      exercises: [
        ...
        },
        {
          id: 2,
          image: '',
          title: 'Баланс в основной стойке ddd',
          description: 'Удерживание равновесия в основной стойке в разных ситуациях bbbb',
          time: 20,
          level: 2
        },
        {
          id: 2,
          image: '',
          title: 'Баланс в основной стойке aaa',
          description: 'Удерживание равновесия в основной стойке в разных ситуациях zzz',
          time: 15,
          level: 3
        },
      ],
