  ...
  <div class="dropdown">
    <div class="dropdown__header">
      <div class="dropdown__header-left">
        <div class="dropdown__header-top">
          ...
          <div class="dropdown__header-row">
            <div class="dropdown__title">{{ goal.goal.title }}</div>
        ...
        <div class="dropdown__header-descr">
          ...
          <p class="dropdown__header-descr-text">{{ goal.goal.exercise.description }}</p>
        </div>
      </div>
      <div class="dropdown__header-calendar">
        ...
        <div class="dropdown__header-calendar-title">{{ date }}</div>
      </div>
    </div>
    ...
    <modal-create-goal :visible="dialogCreateGoal" @close="dialogCreateGoal = false" v-if="dialogCreateGoal" />
  </div>
</template>
...
export default {
  ...
  computed: {
    date() {
      const date = new Date(this.goal.completeUntil)
