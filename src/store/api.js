...
export const AuthApi = {
  /**
    ...
    @param keepLogged String required
  **/
  async login(request) {
    try {
...
export const HistoryResource = {
  async addWorkplace(request) {
    try {
      const { data } = await HTTP_GRAF.post('/history/workplaces/', {
        ...request,
      })
      return [null, data]
    } catch (error) {
  ...
  async editWorkplace(request) {
    try {
      const { data } = await HTTP_GRAF.put('/history/workplaces/:id/'.replace(':id', request.id), {
        ...request,
      })
      return [null, data]
    } catch (error) {
  ...
  async deleteWorkplace(id) {
    try {
      const { data } = await HTTP_GRAF.delete('/history/workplaces/:id/'.replace(':id', id))
      return [null, data]
    } catch (error) {
      return [error, null]
    }
  ...
  async addEducation(request) {
    try {
      const { data } = await HTTP_GRAF.post('/history/educations/', {
        ...request,
      })
      return [null, data]
    } catch (error) {
  ...
  async editEducation(request) {
    try {
      const { data } = await HTTP_GRAF.put('/history/educations/:id/'.replace(':id', request.id), {
        ...request,
      })
      return [null, data]
    } catch (error) {
  ...
  async deleteEducation(id) {
    try {
      const { data } = await HTTP_GRAF.delete('/history/educations/:id/'.replace(':id', id))
      return [null, data]
    } catch (error) {
      return [error, null]
    }
