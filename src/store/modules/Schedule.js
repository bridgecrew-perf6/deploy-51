import { SET_PLANS, RESET, SET_GROUPS, SET_SINGLE_PLAN, SET_EXER, SET_PARTS } from '../mutation-types'
...
const actions = {
  ...
  async loadPlan({ commit }, payload) {
    await PlanResource.single(payload)
      .then(response => {
