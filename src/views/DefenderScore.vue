    ...
    <div class="container match-score__container">
      ...
      <rate-player
        ...
        <template #ratings>
          <div>
            <rating-block
                class="characteristic-rating"
                title="Расположение на площадке"
                :items="locationField" />
...
import RatePlayer from "@/components/RatePlayer/RatePlayer";
...
import RatingBlock from "@/components/RatePlayer/RatingBlock";
...
export default {
  ...
  data() {
    return {
      ...
      specialTeams: [
        {
          label: 'Защитник большинства ',
          value: 1,
        },
        {
          label: 'Защитник меньшинства',
          value: 2,
        },
      ],
      roleTeam: [
        {
          label: 'Защитник I пары ',
          value: 1,
        },
        {
          label: 'Защитник II пары',
          value: 2,
        },
        {
          label: 'Защитник III пары',
          value: 3,
        },
        {
          label: 'Резервный защитник',
          value: 4,
        },
      ],
      playStyle: [
        {
          label: 'Атакующий защитник ',
          value: 1,
        },
        {
          label: 'Домосед',
