<template lang="pug">
  div()
    div(style="display: flex;")
      input.input-search(placeholder="Что будем искать?")
      ul.buttons-block
        li.buttons-item
          svg(width='32' height='32' viewbox='0 0 32 32' fill='none' xmlns='http://www.w3.org/2000/svg')
            rect(width='32' height='32' fill='#F0EFF8')
            path(d='M28 16C28 13 26 11.5 24 11V15C24 20 19.5 22 14.5 23.5C14.5 23.5 17 24.6863 19 25.5C20.7583 26.2153 23 27 23 27V24C26 24 28 22 28 19V16Z' fill='#ACA3DD')
            path(d='M10 20V23L15.8125 20.7499C18.625 19.6249 22 19 22 14V11C22 8 20 4.9999 16 5H10C6 5 4 8 4 11V14.125C4 16.9375 6 20 10 20Z' fill='#ACA3DD')
        li.buttons-item
          svg(width='32' height='32' viewbox='0 0 32 32' fill='none' xmlns='http://www.w3.org/2000/svg')
            rect(width='32' height='32' fill='#F0EFF8')
            path(d='M8.94115 12V17C6.44112 16.9999 5.94112 22 9.94113 21.9999H21.9411C25.9411 21.9999 25.4411 17 22.9411 17L22.9411 11.9999C22.9411 7.99994 19.9411 4.99994 15.9411 5C11.9412 5.00006 8.94115 7.99994 8.94115 12Z' fill='#ACA3DD')
            path(d='M17.5 24H14.5C12.5 24 12.5 27 14.5 27H17.5C19.5 27 19.5 24 17.5 24Z' fill='#ACA3DD')
        li.buttons-item
          svg(width='32' height='32' viewbox='0 0 32 32' fill='none' xmlns='http://www.w3.org/2000/svg')
            rect(width='32' height='32' fill='#F0EFF8')
            circle(cx='16' cy='9' r='4' fill='#ACA3DD')
            path(d='M21 17C19.5 15.5 18 15 16.0001 15C14.0002 15 12.5155 15.4843 11 17C9.48452 18.5157 8 21 8 23C8 25 10.0002 25.0006 16.0001 25.0003H16.0005C22.0001 25.0001 24 25 24 23C24 21 22.5 18.5 21 17Z' fill='#ACA3DD')



    v-row(style="margin: 38px 0 38px 0")
      v-col(md="12")
        router-view
  //
...
export default {
  ...
  /*
      ...
      ScheduleHeader.mb-16(title='Личный кабинет2')
